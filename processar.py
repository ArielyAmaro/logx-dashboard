...
CSV='Relatorio_IAN.csv'; TEMPLATE='dash_v3_template.html'; JS='js_final.js'; OUT='index.html'
...
for _, row in df.iterrows():
    ...
    # mes/ano por abertura (usado em Visao Geral, Processos, Variacao Mensal)
    mes_ab, ano_ab = get_mes_ano(vals[2])
    # mes/ano por ETD (usado no Datamar View)
    if etd:
        mes_etd, ano_etd = get_mes_ano(vals[3])
    else:
        mes_etd, ano_etd = mes_ab, ano_ab
    # campo mes/ano principal = abertura
    mes, ano = mes_ab, ano_ab
