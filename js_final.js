...
function rLista(campo,listId,txtId,anoId,mesId){
  ...
  h+='<div style="display:flex;align-items:center;gap:6px;padding:0 8px 6px;border-bottom:1px solid #1a1a1a;margin-bottom:2px;">'
    ...
    +'<div style="flex:1;font-size:8px;color:#555;text-transform:uppercase;letter-spacing:.5px;">Nome</div>'
    +'<div style="width:65px;font-size:8px;color:#555;text-transform:uppercase;flex-shrink:0;">TEUs</div>'
    ...
    +'<div style="width:38px;text-align:right;font-size:8px;color:#555;text-transform:uppercase;flex-shrink:0;">Proc.</div>'
  ...
  rows.forEach(function(e,i){
    ...
    h+='<div class="eitem" data-campo="'+campo+'" data-idx="'+i+'" style="padding:5px 8px;border-bottom:1px solid #111;">'
      ...
      +'<div style="font-size:9px;color:#ddd;flex-shrink:0;min-width:32px;text-align:right;">'+fmt(d.teus)+'</div>'
      +'</div></div>'
      +compHtml
  ...
  container.innerHTML=h||'<div style="color:#555;padding:16px;text-align:center;">Nenhum resultado</div>';
  var _rows=rows;
